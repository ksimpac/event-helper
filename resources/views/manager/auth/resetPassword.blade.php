    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('manager.resetPassword.update') }}">
                        @csrf
                        @method('PATCH')
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="originalPassword" type="password"
                                    class="form-control @error('originalPassword') is-invalid @enderror"
                                    name="originalPassword" required autofocus>
