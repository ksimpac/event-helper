        ...
        <div class="col-sm-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">{{ substr($participant->dateStart, 0, 16)." ~ ".substr($participant->dateEnd, 0, 16) }}</p>
            </div>
        ...
        <div class="col-sm-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">{{ substr($collection->dateStart, 0, 16)." ~ ".substr($collection->dateEnd, 0, 16) }}</p>
            </div>
            <div class="card-footer d-flex">
